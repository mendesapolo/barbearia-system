 ...
 */
public class CorteForm extends javax.swing.JDialog {
     ...
     */
    public CorteForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void loadCategorias(){
        this.cbCategorias.removeAllItems();
        for(Categoria c : new CategoriaDao().findAll()){
            this.cbCategorias.addItem(c);
        }
    }
    
    public void listTable(){
        this.dataTable.setModel(new CorteAdapter());
    }
    ...
    private void initComponents() {
        ...
        cbCategorias.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/barbearia/arisol/views/assets/icons8-scissors-16.png"))); // NOI18N
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(cbCategorias, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(cbCategorias, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        String precoAux = txtPreco.getText();
        if(nome != null && !nome.equals("")){
            if(precoAux != null && !precoAux.equals("")){
                double preco = Double.parseDouble(precoAux);
                Corte c = new Corte(nome, descricao, preco, categoria);
                ...
                GenericMessage.requiredData(this, "Preço");
            }
        }else{
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if(idx >= 0){
            ...
            if(nome != null && !nome.equals("")){
                if(precoAux != null && !precoAux.equals("")){
                    double preco = Double.parseDouble(precoAux);
                    Corte c = new CorteAdapter().getRow(idx);
                    c.setNome(nome)
                        .setPreco(preco)
                        .setCategoria(categoria)
                        .setDescrcao(descricao);
                    corteDao.update(c);
                    GenericMessage.showSuccess(this);
                    clean();
                    listTable();
    ...
    private void dataTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dataTableMouseClicked
        ...
        if(idx >= 0){
            ...
            this.txtPreco.setText(c.getPreco()+"");
            this.cbCategorias.setSelectedItem(c);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CorteForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CorteForm dialog = new CorteForm(new javax.swing.JFrame(), true);
